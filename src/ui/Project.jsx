...
export default function Project({ project, important = false }) {
  ...
  return (
    <div
      ...
      className="group cursor-pointer relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50"
    >
      ...
      <img
        ...
        className={`rounded border-2 ${
          important ? "border-yellow-600" : "border-slate-200/10"
        } transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1`}
